      ...
      {isLoading ? (
        ...
        <div className="space-y-8">
            ...
            <div className="lg:col-span-7">
              <div className="relative overflow-hidden rounded-2xl border border-[#CDA54E]/40 bg-gradient-to-br from-[#0B1542] via-[#101D63] to-[#1E1758] p-6 text-white shadow-xl sm:p-8">
                ...
                <div className="relative z-10 flex items-start justify-between gap-4 border-b border-white/10 pb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <h4 className=" font-bold text-white sm:text-base">
                        Association of Chartered Loss Prevention Specialists
                      </h4>
                    </div>
                  </div>

                  <span className="inline-flex items-center gap-1.5 rounded-full bg-[#10B981]/20 px-3 py-1  font-semibold text-[#6EE7B7] backdrop-blur-sm">
                ...
                <div className="relative z-10 my-6 space-y-2">
                  <p className=" font-medium uppercase tracking-wider text-white/60">
                    Registered Member
                  </p>
                  ...
                  <p className=" font-semibold text-[#E5C77A]">
                    {membership.name}
                  </p>
                </div>
                ...
                <div className="relative z-10 flex flex-wrap items-end justify-between gap-4 border-t border-white/10 pt-6">
                  <div>
                    <span className="block  font-medium uppercase tracking-wider text-white/50">
                  ...
                  <div className="text-right">
                    ...
                    <span className="mt-1 block font-mono  font-bold text-white">
            ...
            <div className="flex flex-col justify-between gap-4 rounded-2xl border border-sand bg-white p-6 shadow-sm lg:col-span-5">
              <div className="space-y-4">
                ...
                <dl className="grid grid-cols-2 gap-4 ">
                  <div className="rounded-xl bg-cream/70 p-3">
                    <dt className=" text-text/60">Standing</dt>
                    <dd className="mt-1 font-semibold text-[#10B981]">
                      In Good Standing
                    </dd>
                  </div>
                  <div className="rounded-xl bg-cream/70 p-3">
                    <dt className=" text-text/60">Term Duration</dt>
                    <dd className="mt-1 font-semibold text-[#101D63]">
                      {membership.duration || "1 Year"}
                    </dd>
                  </div>
                  <div className="rounded-xl bg-cream/70 p-3">
                    <dt className=" text-text/60">Auto-Renewal</dt>
                    <dd className="mt-1 font-semibold text-[#101D63]">
                      {membership.autoRenewal ? "Enabled" : "Manual"}
                    </dd>
                  </div>
                  <div className="rounded-xl bg-cream/70 p-3">
                    <dt className=" text-text/60">Enrolled Since</dt>
                    <dd className="mt-1 font-semibold text-[#101D63]">
              ...
              <div className="flex flex-col gap-2 pt-2">
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-xl border border-sand bg-cream/40 px-4 py-2.5  font-semibold text-[#101D63] transition hover:bg-cream"
                >
                  <HugeiconsIcon
                    icon={Invoice01Icon}
                    size={16}
                ...
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-xl px-4 py-2  font-medium text-text/60 transition hover:text-text"
                >
          ...
          <div className="rounded-2xl border border-sand bg-white p-6 shadow-sm sm:p-8">
            <div className="mb-6 flex flex-col justify-between gap-2 sm:flex-row sm:items-center">
              ...
              <span className="inline-flex items-center gap-1.5 rounded-full bg-[#CDA54E]/15 px-3 py-1  font-bold text-[#9A7326]">
                <HugeiconsIcon
                  icon={SparklesIcon}
                  size={14}
                  color="currentColor"
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {(membership.benefits && membership.benefits.length > 0
                ...
                >
                  ...
                  <span className=" leading-relaxed font-medium text-[#101D63]">
                    {benefit}
                  </span>
                </div>
              ))}
            ...
            <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="max-w-xl  text-text/70 sm:">
              ...
              <div className="flex shrink-0 items-center gap-3">
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-xl bg-[#101D63] px-5 py-2.5  font-semibold text-white shadow-sm transition hover:bg-[#1E1758]"
                >
                  <HugeiconsIcon
                    icon={Download01Icon}
                    size={16}
        ...
        <div className="space-y-8">
          <div className="rounded-2xl border border-sand bg-white p-8 text-center shadow-sm sm:p-12">
            ...
            <p className="mx-auto mt-2 max-w-lg  text-text/70">
            ...
            <div className="mt-6 flex justify-center">
              <Link
                href="/membership"
                className="inline-flex items-center gap-2 rounded-xl bg-[#101D63] px-6 py-3  font-bold text-white shadow transition hover:bg-[#1E1758]"
              >
                ...
                {publicMemberships.map((tier) => (
                  ...
                  >
                    <div className="space-y-3">
                      <span className="inline-block rounded-full bg-cream px-3 py-1  font-semibold text-[#101D63]">
                    ...
                    <Link
                      ...
                      className="mt-5 inline-flex w-full items-center justify-center gap-1.5 rounded-xl border border-sand bg-cream/50 py-2.5  font-bold text-[#101D63] transition hover:bg-[#101D63] hover:text-white"
                    >
