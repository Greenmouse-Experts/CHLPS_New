      ...
      <PageContainer className="relative h-full">
        <div className="flex h-full items-center py-10 sm:py-12 lg:py-8">
          <div className="w-full max-w-[640px] xl:max-w-[720px]">
            ...
            <Reveal delay={160}>
              <p className="mt-4 max-w-[26rem] text-[15px] leading-relaxed text-white/95 sm:text-base lg:mt-5 lg:text-lg">
                A credible professional home for loss prevention, security, risk
